...
def test__enforce_data_quality():
    ...
    # when
    enforced_data_quality_df = DataCleaner._enforce_data_quality(df)
...
def test__enforce_data_quality__index_is_not_monotonic_increasing():
    ...
    # when
    index_monotic_increasing_df = DataCleaner._enforce_data_quality(df)
...
def test__enforce_data_quality__index_is_not_unique():
    ...
    # when
    index_unique_increasing_df = DataCleaner._enforce_data_quality(df)
